...
const loginpage = () => {
  ...
  return (
   ...
   rounded-2xl shadow-xl overflow-hidden mx-auto mt-20"
    >
      <div className="p-8">
        <h2 className="text-3xl  font-bold mb-6 text-center  text-purple-100 rounded-lg ">
          Welcome Back
        </h2>
        <form onSubmit={handleLogin}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full py-3 px-4 bg-purple-600 text-white font-semibold rounded-lg shadow-lg
